    ...
    <main className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="pt-20">
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          {/* Header for Events */}
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Événements à venir</h1>
              ...
              >
                ...
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute top-4 right-4 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm px-3 py-1 rounded-full">
                    <span className="text-blue-600 dark:text-blue-400 font-medium">{event.price}€</span>
                  </div>
                </div>
                ...
                <div className="p-4">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">{event.artist}</p>
        ...
        {/* Section Catégories */}
        <div className="max-w-7xl mx-auto px-4 py-8"> {/* Réduction du padding */}
